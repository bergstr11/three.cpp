...
bool checkIntersection(const Object3D &object,
...
math::Vector2 uvIntersection(const math::Vector3 &point, const math::Vector3 &p1, const math::Vector3 &p2,
...
bool checkBufferGeometryIntersection(const Object3D &object,
                                     const Raycaster &raycaster,
                                     const math::Ray &ray,
